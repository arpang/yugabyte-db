...
-- YB note: port additional tests once MERGE is supported.
DROP TABLE gtestm;
...
ALTER TABLE gtest25 ADD COLUMN b int GENERATED ALWAYS AS (a * 3) STORED; -- YB note: additional notice.
...
ALTER TABLE gtest25 ADD COLUMN c int DEFAULT 42,
  ADD COLUMN x int GENERATED ALWAYS AS (c * 4) STORED; -- YB note: additional notice.
