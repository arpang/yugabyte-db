BEGIN;
  ...
  UPDATE pg_catalog.pg_proc SET provolatile='v', proargnames='{indexrelid,batch_mode}',
  proargdefaults='({CONST :consttype 16 :consttypmod -1 :constcollid 0 :constlen 1 :constbyval true :constisnull false :location 84 :constvalue 1 [ 1 0 0 0 0 0 0 0 ]})',
