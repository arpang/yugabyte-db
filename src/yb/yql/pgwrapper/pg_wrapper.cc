...
DEFINE_RUNTIME_PG_FLAG(uint32, yb_notifications_poll_sleep_duration_nonempty_ms, 1,  // 1 ms
...
DEFINE_RUNTIME_PG_FLAG(uint32, yb_notifications_poll_sleep_duration_empty_ms, 100,  // 100 ms
    "Time in milliseconds for which the notifications poller process waits before polling again "
