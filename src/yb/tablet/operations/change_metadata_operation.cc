...
//                  "Used in tests to ignore applying change metadata operation"
//                  " on followers.");
// TAG_FLAG(TEST_ignore_apply_change_metadata_on_followers, runtime);

DEFINE_test_flag(bool, no_update_last_change_metadata_op, false,
                 "Used in tests to not update last_change_metadata_op_id to simulate "
                 "behavior of old code");
// TAG_FLAG(TEST_no_update_last_change_metadata_op, runtime);
